...
<body>
    ...
    <p>La prueba estará compuesta por <span class="negrita">50 preguntas de opción múltiple y tendrá una duración de 2 horas.</span></p>
<p>La jornada será de <span class="negrita">9:00 a 14 h</span> y las actividades que se realizarán son:<p>
<ul>
    <li>Prueba con una duración de 2 horas.</li>
    ...
    <li><a target="_blank" href="pdfs/Ejemplo_de_prueba.pdf">En este enlace pueden descargar la prueba que se realizó en las MiniOlimpiadas de Física y Química de 2023 que tuvieron lugar en Albacete.</a></li>
    <ul>
