...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/editarUsuarios.css">
...
<?php
   if ($_SESSION['usuario_login']['rol'] == "0") {
      ?>
<li class="nav-item">
 <a class="nav-link"  href="../archivosComunes/editarPerfil.php">Gestión Usuarios <i class="bi bi-back"></i></a>
</li>
      <?php
        } 
      ?>
                ...
                <form method="POST" class="text-light" action="actualizar.php?idusuario=<?php echo $_SESSION['usu_editar']['cod_usuario'] ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="validacionDelphos" placeholder="Introduce el código de Delphos" name="validacionDelphos" value='<?php echo $_SESSION["usu_editar"]["cod_delphos"] ?>'>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="validacionTutor" id="validacionTutor" class="selectPersonal form-control form-control-lg">
