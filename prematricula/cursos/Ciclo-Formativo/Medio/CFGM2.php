    ...
    <div class="fondo">
        <div class="matricula mt-4">
            ...
            <form id="matriculas" action="../../../generate_pdf.php" method="post">
                <input type="hidden" name="curso" value="SMR2">
                ...
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <tbody>
                        <?php  
                            $select = "SELECT cod_asignatura, nombre, horas, curso, tipo FROM asignaturas WHERE curso LIKE 'CFGB1' AND tipo LIKE '%comunes'";
