...
<?php
    ...
    <div class="fondo">
        <div class="matricula mt-4">
            <h1 style="text-align: right; color: green; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">2ºESO</h1>
            <form id="matriculas" action="../../generate_pdf.php" method="post">
                <input type="hidden" name="curso" value="2ESO">
