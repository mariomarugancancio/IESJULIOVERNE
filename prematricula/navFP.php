...
if (isset($_GET['cod_matricula'])) {
  ...
  $select = "SELECT cod_alumnosMatriculados, nombre_alumno, primer_apellido_alumno, segundo_apellido_alumno,
            ...
            centro, localidad_centro, provincia_centro, curso_antiguo, bilingue, religion, trabaja, cambio, email_alumno, telefono_alumno, ampa
    ...
    <a class="navbar-brand ms-xl-5" href="/iesjulioverne/prematricula/prematricula.php">Prematrícula 2024/2025</a>
      ...
      <div class="collapse navbar-collapse  text-center" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
         ...
         <li class="nav-item">
         <a class="text-light btn btn-outline-secondary me-2" href="/iesjulioverne/archivosComunes/actualizarUsuario.php?idusuario=' . $_SESSION['usuario_login']['cod_usuario'] . '">
         <span class="d-flex">
         ...
         <li class="nav-item">
        <a class="nav-link"  href="/iesjulioverne/archivosComunes/selector.php">Página Principal <i class="bi bi-back"></i></a>
        </li>

        <li class="nav-item">
            <a class="nav-link"  href="/iesjulioverne/archivosComunes/logout.php">Cerrar Sesion</a>
            </li>
            </div>
            </div>
            </ul> 
