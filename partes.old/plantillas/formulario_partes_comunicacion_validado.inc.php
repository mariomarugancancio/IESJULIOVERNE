        ...
        <div class="panel panel-default" >
            <div class="panel-heading" >
                <h3 class="text-center mifuente minegrita miversalita micoloretiqueta ">
                    Información datos de contacto del alumno
                </h3>
            </div>
            <div class="panel-body">
                <div> 
...
<div class="row">
    <div class="col-md-12">
        <?php
        if (isset($_SESSION["error_comunicacion"])) {
            $validar = new ValidarParte();
            $validar->getError($_SESSION["error_comunicacion"]);
            unset($_SESSION["error_comunicacion"]);
        }
        ?> 
    </div>
</div>
